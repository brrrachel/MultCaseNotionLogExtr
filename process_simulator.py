...
class ProcessSimulator:
    ...
    def __init__(self):
        ...
        # create table log
        self.tableLog = pd.DataFrame(columns=['activity','timestamp','rental','inventory','customer','staff','inspection','payment','lifecycle'])
    ...
    def __create_entry_for_table_log__(self, activity: str, timestamp: datetime.datetime, rental='EMPTY', inventory='EMPTY', customer='EMPTY', staff='EMPTY', inspection='EMPTY', payment='EMPTY', lifecycle='complete'):
    ...
    def create_payment(self, rental_id: int, inventory_ids: list, date: datetime.datetime):
        ...
        self.__create_entry_for_table_log__('create_payment', date, rental=rental_id, staff=staff_id, payment=payment_id, customer=customer_id)
    ...
    def confirm_payment(self, rental_id: int, payment_id: int, date: datetime.datetime, inventory_id: int):
        ...
        self.payments.loc[payment_id, self.payments.columns.get_loc('confirmed_date')] = date
        customer_id = self.__get_customer_of_rental__(rental_id)
        self.__create_entry_for_table_log__('confirm_payment', date, rental= rental_id, payment=payment_id, staff=staff_id, customer=customer_id)
    ...
    def confirm_rental(self, rental_id: int, date: datetime.datetime):
        ...
        staff_id = self.__get_staff_id_for_inventory__(inventory_id)
        customer_id = self.__get_customer_of_rental__(rental_id)
        self.__create_entry_for_table_log__('confirm_rental', date, rental=rental_id, staff=staff_id, customer=customer_id)
